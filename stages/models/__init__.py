...
from . import models
from . import stages_candidature
from . import stages_carriere
from . import stages_change_periode
from . import stages_conseil
...
from . import stages_grade
from . import stages_stage_type
from . import stages_laboratoire
